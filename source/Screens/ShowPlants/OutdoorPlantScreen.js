...
import OutPlantBottom from "../../Components/OutPlantBottom";
import { useNavigation } from "@react-navigation/native";
// import {ref, set} from "firebase/database"
const OutdoorPlantScreen = ({ navigtaion }) => {
  ...
  // useLayoutEffect(() => {
  //   const ref = collection(db, "OutdoorPlants");
  //   onSnapshot(ref, (OutdoorPlants) =>
  //     setdata(
  //       OutdoorPlants.docs.map((OutdoorPlants) => ({
  //         id: OutdoorPlants.id,
  //         data: OutdoorPlants.data(),
  //       }))
  //     )
  ...
  //   const docRef = doc(db, "OutdoorPlants", item.id);
...
export default OutdoorPlantScreen;
