...
import SeasonPlantBottom from "../../Components/SeasonPlantBottom";
import { useNavigation } from "@react-navigation/native";
//import {ref, set} from "firebase/database"
const SeasonalPlantScreen = ({ navigtaion }) => {
  ...
  // useLayoutEffect(() => {
  //   const ref = collection(db, "SeasonalPlants");
  //   onSnapshot(ref, (SeasonalPlants) =>
  //     setdata(
  //       SeasonalPlants.docs.map((SeasonalPlants) => ({
  //         id: SeasonalPlants.id,
  //         data: SeasonalPlants.data(),
  //       }))
  //     )
  ...
  //   const docRef = doc(db, "SeasonalPlants", item.id);
...
export default SeasonalPlantScreen;
