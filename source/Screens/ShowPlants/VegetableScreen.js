...
import VegetablePlantBottom from "../../Components/VegetablePlantBottom";
import { useNavigation } from "@react-navigation/native";
//import {ref, set} from "firebase/database"
const VegetableScreen = ({ navigtaion }) => {
  ...
  // useLayoutEffect(() => {
  //   const ref = collection(db, "VegetablePlants");
  //   onSnapshot(ref, (VegetablePlants) =>
  //     setdata(
  //       VegetablePlants.docs.map((VegetablePlants) => ({
  //         id: VegetablePlants.id,
  //         data: VegetablePlants.data(),
  //       }))
  //     )
  ...
  //   const docRef = doc(db, "VegetablePlants", item.id);
