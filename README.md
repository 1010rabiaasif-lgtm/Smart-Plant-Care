...
▶️ [Watch the working prototype demo](https://drive.google.com/drive/folders/11-8LN-BqJLmDrGyBljAHtmVppUkdwCb2)

> The physical prototype was submitted to the university as part of the FYP requirement. The demo video above shows the complete system working — sensors detecting conditions, Firebase receiving real-time data, and the app triggering automated plant care actions.
